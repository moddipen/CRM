        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-lg-12 my-3">
                <div class="card panel-primary">
                    ...
                    <div class="card-body">
                        <!--main content-->
                        <form id="commentForm" action="{{route('error.store')}}"
                            ...
                            <div id="rootwizard">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane " id="tab1">
                                        ...
                                        <button align = 'center' type="submit" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left" data-original-title="Add Error" id="delButton">Create</button>
                                    </div>
                                    </div>
                                </div>
                            </div>

...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Edit General Leave</li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-lg-12 my-3">
                <div class="card panel-primary">
                    ...
                    <div class="card-body">
                        <!--main content-->
                        {!! Form::model($editLeave, ['url' =>route('general.leave.update',$editLeave->id ), 'method' => 'put', 'class' => 'form-horizontal','id'=>'commentForm', 'enctype'=>'multipart/form-data','files'=> true]) !!}
                        {{ csrf_field() }}
                        <!-- CSRF Token -->
                            ...
                            <div id="rootwizard">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane " id="tab1">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input id="name" name="title" type="text"
                                                           ...
                                                           value="{!! old('title', $editLeave->title) !!}"/>
                                                ...
                                                <label for="From" class="col-sm-2 control-label">
                                                    ...
                                                    <div class="col-sm-10">
                                                         <div class="input-group">
                                                            <input type="text" readonly name="date" class="form-control" value="{!! old('date',$editLeave->date) !!}"  id="rangepicker47" />
                                        ...
                                        <button align = 'center' type="submit" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left" data-original-title="Update General Leave" id="delButton">Update</button>
                                    </div>

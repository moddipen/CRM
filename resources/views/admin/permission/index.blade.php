    ...
    <div class="row">
        ...
        <div class="card panel-success ">
            <div class="card-heading">
                ...
                @if(Auth::user()->hasAnyPermission(['create-permission']))
                <div class="pull-right">	                
	                <a href="{{route('permission.create')}}" type="button" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="left" data-original-title="Add New Permission" id="delButton"><i class="fa fa-plus"></i>Add New</a>
	            </div>
                @endif
            </div>
            <div class="card-body">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure to delete this Permission? This operation is irreversible.
                </div>
...
//     var modal = $(this)
//     modal.find('.modal-footer a').prop("href",$url_path+"/admin/permission/"+$recipient+"/delete");
// })

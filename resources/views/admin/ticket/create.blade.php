...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{route('error.index')}}">Ticket</a></li>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-lg-12 my-3">
                <div class="card panel-primary">
                    ...
                    <div class="card-body">
                        <!--main content-->
                        <form id="commentForm" action="{{route('ticket.store')}}"
                            ...
                            <div id="rootwizard">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane " id="tab1">
                                                ...
                                                <label for="first_name" class="col-sm-2 control-label">Ticket Number*</label>
                                                    <div class="col-sm-10">
                                                        <input id="name" name="ticket_number" type="text"
                                                               placeholder="ticket_number" readonly class="form-control required"
                                                               value="{{$ticket_number}}"/>
                                        ...
                                        <button align = 'center' type="submit" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left" data-original-title="Add Ticket" id="delButton">Create</button>
                                    </div>
                                    </div>
                                </div>
                            </div>

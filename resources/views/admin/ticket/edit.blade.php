        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-lg-12 my-3">
                <div class="card panel-primary">
                    ...
                    <div class="card-body">
                        <!--main content-->
                        {!! Form::model($editTicket, ['url' =>route('ticket.update',$editTicket->id ), 'method' => 'put', 'class' => 'form-horizontal','id'=>'commentForm', 'enctype'=>'multipart/form-data','files'=> true]) !!}
                        {{ csrf_field() }}
                        <!-- CSRF Token -->
                            ...
                            <div id="rootwizard">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane " id="tab1">
                                        <h2 class="hidden">&nbsp;</h2>
                                        <div class="form-group {{ $errors->first('ticket_number', 'has-error') }}">
                                            <div class="row">
                                                <label for="first_name" class="col-sm-2 control-label">Ticket Number *</label>
                                                <div class="col-sm-10">
                                                    <input id="name" name="ticket_number" type="text"
                                                            disabled class="form-control required"
                                                           value="{!! old('ticket_number', $editTicket->ticket_number) !!}"/>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input id="name" name="title" type="text"
                                                           ...
                                                           value="{!! old('title', $editTicket->title) !!}"/>
                                        ...
                                        <div class="form-group {{ $errors->first('description', 'has-error') }}">
                                            <div class="row">
                                                <label for="first_name" class="col-sm-2 control-label">Description *</label>
                                                    <div class="col-sm-10">
                                                        <textarea id="name" name="description" type="text"
                                                               placeholder="Description" class="form-control required"
                                                               value="{!! old('description',$editTicket->description) !!}">{!! old('description',$editTicket->description) !!}</textarea>
                                                        {!! $errors->first('description', '<span class="help-block">:message</span>') !!}
                                                    </div>
                                            </div>
                                        </div>
                                        <button align = 'center' type="submit" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left" data-original-title="Update Ticket" id="delButton">Update</button>
                                    </div>

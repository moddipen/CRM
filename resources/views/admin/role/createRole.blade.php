        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-lg-12 my-3">
                <div class="card panel-primary">
                    ...
                    <div class="card-body">
                        <!--main content-->
                        <form id="commentForm" action="{{route('role.store')}}"
                                        ...
                                        <div class="form-group {{ $errors->first('permission', 'has-error') }}">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input id="name" name="permission[]" type="checkbox"
                                            ...
                                            <button align = 'center' type="submit" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left" data-original-title="Create Role" id="delButton">Create</button>
                                     </div>
                                    </div>
                                </div>
                            </div>

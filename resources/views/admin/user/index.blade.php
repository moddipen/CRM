        ...
        <div class="card panel-success ">
            <div class="card-heading">
                ...
                <div class="pull-right">	                
	                <a href="{{ route('user.create') }}" type="button" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="left" data-original-title="Add New User" id="delButton"><i class="fa fa-plus"></i>Add New</a>
	            </div>
                @endif
            </div>
            <div class="card-body">

...
<head>
    ...
    <!-- page level styles-->
    <link rel="stylesheet" type="text/css" href="{{ asset('public/assets/css/pages/404.css') }}" />
...
<body>
    ...
    <div class="hgroup">
        ...
        <a href="{{ route('home') }}" class="btn btn-responsive btn-default button-alignment">Home
        </a>
    </div>
    <!-- global js -->
    ...
    <script src="{{ asset('public/assets/js/404.js') }}"></script>
